...
var login_utils = require("./login_utils.js");
...
router.get('/send_to_spotify_for_login', function(req, res) {
	...
	//TODO CLEANUP do we need 19/20/28 for this whole state thing? also the generateRandomString()
...
router.get('/spotify_redirect', function(req, res) {
	...
	if (!req.error && req.query.code) {
		...
		res.redirect("/?error=spotify_failed_to_redirect_back_to_us_with_data");
	}
});
